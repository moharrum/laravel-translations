...
namespace Moharrum\LaravelTranslations\Entities;
...
/**
 * The translation eloquent model implementation.
 *
...
class Translation extends Model
{
    ...
    public function __construct(array $attributes = [])
    {
        ...
        $this->setTable(config('laravel-translations.table'));
    }
    ...
    public static function getCacheKey(string $locale, string $group, ?string $namespace = null): string
    {
        ...
        return "moharrum.laravel-translations.{$namespace}." . str_replace('/', '.', $group) . ".{$locale}";
    }
